...
//	private List<Polja> jabolkaPozicija = new ArrayList<>();
		...
		while (true) {
			if (zacni) {
				if (! isKoncano()) {
					...
					//
					//
					// Najverjetneje je hrosc v tem delu
					// Vcasih ustvari 3 ali pa 4 jabolka namesto samo enega ali pa jih ne izbrise iz list-a
					//
					//
					// Dodal sem, da ce je list prazen, torej da ni nobene jabolke, ustvari novo jabolko
